...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header">Setting <small>Phase</small></h1>
...
<script>
  ...
  var jsonList   = "setting/phase/jsonList";
  var formAdd    = "setting/phase/formAdd";
  var formEdit   = "setting/phase/formEdit";
  var procRemove = "setting/phase/processRemove";
  var selTable   = '#tbl';
