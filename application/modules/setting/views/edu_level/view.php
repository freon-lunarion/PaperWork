...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header">Setting <small>Education Level</small></h1>
...
<script>
  ...
  var jsonList   = "setting/edu_level/jsonList";
  var formAdd    = "setting/edu_level/formAdd";
  var formEdit   = "setting/edu_level/formEdit";
  var procRemove = "setting/edu_level/processRemove";
  var selTable   = '#tbl';
