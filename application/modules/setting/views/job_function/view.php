...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header">Setting <small>Job Function</small></h1>
...
<script>
  ...
  var jsonList   = "setting/job_function/jsonList";
  var formAdd    = "setting/job_function/formAdd";
  var formEdit   = "setting/job_function/formEdit";
  var procRemove = "setting/job_function/processRemove";
  var selTable   = '#tbl';
