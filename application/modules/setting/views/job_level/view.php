...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header">Setting <small>Job Level</small></h1>
...
<script>
  ...
  var jsonList   = "setting/job_level/jsonList";
  var formAdd    = "setting/job_level/formAdd";
  var formEdit   = "setting/job_level/formEdit";
  var procRemove = "setting/job_level/processRemove";
  var selTable   = '#tbl';
